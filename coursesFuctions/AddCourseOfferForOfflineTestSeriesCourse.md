-- Create function to add course offer for Offline Test Series Course
create function "AddCourseOfferForOfflineTestSeriesCourse"(totalamount integer) returns void
    language plpgsql
as
$$
DECLARE
