-- Create function to calculate results for offline test attempts based on testId
create function "CalculateOfflineTestAttemptResults"(testid integer) returns void
    language plpgsql
as
$$
BEGIN
...
alter function "CalculateOfflineTestAttemptResults"(integer) owner to learner;
