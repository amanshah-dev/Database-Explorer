-- Create function to calculate results for temporary offline test attempts based on testId and offlineTestAttemptId
create function "CalculateTempOfflineTestAttemptResults"(testid integer, offlinetestattemptid integer) returns void
    language plpgsql
as
$$
BEGIN
...
alter function "CalculateTempOfflineTestAttemptResults"(integer, integer) owner to neetprep_rw;
