CREATE FUNCTION grantfreecourseaccessonpurchase(
...
ALTER FUNCTION grantfreecourseaccessonpurchase(integer, integer, timestamp with time zone) OWNER TO learner;
