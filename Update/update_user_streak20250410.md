create function update_user_streak20250410(p_user_id integer, p_event_count integer) returns integer
    language plpgsql
as
$$
DECLARE
...
alter function update_user_streak20250410(integer, integer) owner to learner;
