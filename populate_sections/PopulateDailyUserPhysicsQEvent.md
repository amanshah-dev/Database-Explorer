create function "PopulateDailyUserPhysicsQEvent"(days integer DEFAULT 1, startdate date DEFAULT '2020-01-01'::date) returns void
    language plpgsql
as
$$
DECLARE
...
BEGIN
    ...
    select "userId", 'PhysicsQuestion', startDate, 
...
alter function "PopulateDailyUserPhysicsQEvent"(integer, date) owner to learner;
