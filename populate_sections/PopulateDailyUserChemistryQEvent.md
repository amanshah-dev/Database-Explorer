create function "PopulateDailyUserChemistryQEvent"(days integer DEFAULT 1, startdate date DEFAULT '2020-01-01'::date) returns void
    language plpgsql
as
$$
DECLARE
...
BEGIN
    ...
    select "userId", 'ChemistryQuestion', startDate, 
...
alter function "PopulateDailyUserChemistryQEvent"(integer, date) owner to learner;
