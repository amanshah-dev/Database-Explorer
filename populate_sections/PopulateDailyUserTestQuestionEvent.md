create function "PopulateDailyUserTestQuestionEvent"(testid integer, days integer DEFAULT 1, startdate date DEFAULT '2023-01-01'::date) returns void
    language plpgsql
as
$$
DECLARE
...
BEGIN
    ...
    select "userId", "testId", 'Question', startDate, count(distinct("Answer"."questionId"))
...
alter function "PopulateDailyUserTestQuestionEvent"(integer, integer, date) owner to learner;
