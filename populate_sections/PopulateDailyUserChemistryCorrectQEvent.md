create function "PopulateDailyUserChemistryCorrectQEvent"(days integer DEFAULT 1, startdate date DEFAULT '2020-01-01'::date) returns void
    language plpgsql
as
$$
DECLARE
...
alter function "PopulateDailyUserChemistryCorrectQEvent"(integer, date) owner to learner;
