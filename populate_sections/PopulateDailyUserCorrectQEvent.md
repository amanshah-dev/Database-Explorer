create function "PopulateDailyUserCorrectQEvent"(days integer DEFAULT 1, startdate date DEFAULT '2020-01-01'::date) returns void
    language plpgsql
as
$$
DECLARE
...
BEGIN
    ...
    select "userId", 'CorrectQuestion', startDate, 
...
alter function "PopulateDailyUserCorrectQEvent"(integer, date) owner to learner;
