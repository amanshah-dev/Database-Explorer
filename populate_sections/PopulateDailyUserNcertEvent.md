create function "PopulateDailyUserNcertEvent"(days integer DEFAULT 1, startdate date DEFAULT '2020-01-01'::date) returns void
    language plpgsql
as
$$
DECLARE
...
alter function "PopulateDailyUserNcertEvent"(integer, date) owner to learner;
