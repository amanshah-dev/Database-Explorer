create function "PopulateDailyQuestionEvent"(datelower timestamp with time zone DEFAULT CURRENT_DATE) returns void
    language plpgsql
as
$$ 
DECLARE 
...
alter function "PopulateDailyQuestionEvent"(timestamp with time zone) owner to learner;
