CREATE FUNCTION "GetTestAttemptResult"(testattemptid integer)
    RETURNS jsonb
    LANGUAGE plpgsql
AS
$$
  ...
  test_results AS (
    SELECT "testAttemptId",
      JSONB_BUILD_OBJECT(
        ...
        ) FILTER (WHERE "sectionName" IS NOT NULL)
      ) AS "result"
...
ALTER FUNCTION "GetTestAttemptResult"(integer) OWNER TO neetprep_rw;
