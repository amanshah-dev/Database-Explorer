CREATE FUNCTION "GetUserTestDetails"(p_userid bigint, p_scheduleid bigint)
    RETURNS TABLE(
        "userId" bigint,
        "scheduleId" bigint,
        "scheduleName" text,
...
ALTER FUNCTION "GetUserTestDetails"(bigint, bigint) OWNER TO learner;

GRANT EXECUTE ON FUNCTION "GetUserTestDetails"(bigint, bigint) TO readaccess;

GRANT EXECUTE ON FUNCTION "GetUserTestDetails"(bigint, bigint) TO readwrite;

GRANT EXECUTE ON FUNCTION "GetUserTestDetails"(bigint, bigint) TO read_user;

GRANT EXECUTE ON FUNCTION "GetUserTestDetails"(bigint, bigint) TO read_user1;
